...
*(v1.0.79+)* The **Sessions tab and sidebar** let you manage multiple concurrent sessions from a single view. You can see all active sessions, switch between them, and monitor their status without navigating away. This complements the My Work view by giving you a focused way to track and control parallel agent tasks.
